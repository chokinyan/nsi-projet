...
class text:
    def __init__(self,texte : str,display : pygame.display,size : int,police : str = 'None',color : pygame.Color = (0,0,0),antialias : bool = False,bold : bool = False,italic : bool = False,background : pygame.Color = None) -> None:
    ...
    def draw(self,*coordonné) -> None:
        self.display.blit(self.txt,coordonné)